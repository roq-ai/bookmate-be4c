  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless scheduling with BookMate, a comprehensive appointment booking system. Built with a dynamic user interface, secure login features, and efficient appointment management tools, BookMate adapts to your needs and simplifies your booking experience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhcHBvaW50bWVudCUyMGJvb2tpbmd8ZW58MHx8fHwxNjkzNDc4NjM0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless scheduling with BookMate, a comprehensive appointment booking system. Built with a dynamic user interface, secure login features, and efficient appointment management tools, BookMate adapts to your needs and simplifies your booking experience.`}
            </Text>
            <Box
