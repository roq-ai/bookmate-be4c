...
export function AppointmentListPage(props: AppointmentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getAppointments({
        relations: ['company', 'time_slot.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('time_slot', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'time_slot',
          header: 'Time Slot',
          accessorKey: 'time_slot',
          cell: ({ row: { original: record } }: any) => record?._count?.time_slot,
        }
      : null,
