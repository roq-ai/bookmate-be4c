...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'staff-member', 'admin'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Calendars', path: '/calendars', entity: 'calendar', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    { name: 'Roles', path: '/roles', entity: 'role', service: AccessServiceEnum.PROJECT, icon: FiShieldOff },
    { name: 'Time Slots', path: '/time-slots', entity: 'time_slot', service: AccessServiceEnum.PROJECT, icon: FiClock },
